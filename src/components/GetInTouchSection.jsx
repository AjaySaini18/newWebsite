...
const GetInTouchSection = () => {
  ...
  return (
    <section className="py-18 bg-white my-10 font-gilroy px-6 md:px-12 lg:px-24">
      <motion.div
        className="container"
        initial="hidden"
        whileInView="visible"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div className="bg-[#F9F9F9] border border-[#DDDDDD] p-6 rounded-lg" variants={fadeUp}>
            ...
            <form className="space-y-3">
              <motion.input type="text" placeholder="First Name" className="w-full bg-white border border-[#DADADA] text-sm sm:text-[13px] placeholder-[#282828] rounded-md font-medium p-4 outline-none" variants={fadeUp} />
              <motion.input type="email" placeholder="Email ID" className="w-full bg-white border border-[#DADADA] text-sm sm:text-[13px] placeholder-[#282828] rounded-md font-medium p-4 outline-none" variants={fadeUp} />
              <motion.input type="text" placeholder="Contact Number" className="w-full bg-white border border-[#DADADA] text-sm sm:text-[13px] placeholder-[#282828] rounded-md font-medium p-4 outline-none" variants={fadeUp} />
              <motion.input type="text" placeholder="Company Name" className="w-full bg-white border border-[#DADADA] text-sm sm:text-[13px] placeholder-[#282828] rounded-md font-medium p-4 outline-none" variants={fadeUp} />
              <motion.textarea placeholder="Tell us more" rows="6" className="w-full bg-white border border-[#DADADA] text-sm sm:text-[13px] placeholder-[#282828] rounded-md font-medium p-4 outline-none" variants={fadeUp} />
              <motion.button type="submit" className="w-full sm:w-auto px-13 text-md font-medium bg-[#4359FF] text-white py-3.5 rounded-md hover:bg-blue-700 transition" variants={fadeUp}>
                Submit
              </motion.button>
            </form>
          </motion.div>
          ...
          <motion.div className="space-y-6 text-[#282828]" variants={fadeUp}>
            ...
            <motion.div className="flex flex-col sm:flex-row items-start font-medium justify-between p-4 border border-[#DDDDDD] rounded-lg" variants={fadeUp}>
              <div className="flex-1">
                ...
                <p className="flex items-center text-sm sm:text-[13px] mt-2">
