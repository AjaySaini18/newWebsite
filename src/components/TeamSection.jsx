...
const teamMembers = [
  {
    ...
    name: "Nimesh Dutta",
    role: "Founder & CEO",
    desc: "Designing intuitive user experiences and collaborative UX, as co-founder/mentor",
  ...
  },
  {
    ...
    name: "Nimesh Dutta",
    role: "Co-Founder & VP",
    desc: "Collaborating and co-leading multiple successful design and product projects",
  ...
  },
  {
    ...
    desc: "Managing product roadmap and cross-functional teams, mentor & advisor",
  ...
  },
  {
    ...
    name: "Nimesh Dutta",
    role: "ML Developer",
    desc: "Working on AI & ML development and mentoring junior developers",
  ...
  },
  {
    ...
    desc: "Building responsive web applications with React & modern UI frameworks",
  ...
  },
  {
    ...
    desc: "Developing scalable backend systems, database management, and APIs",
  ...
  },
  {
    ...
    name: "S. Shubhanker",
    role: "UI/UX Designer",
    desc: "Creating engaging and accessible digital experiences across platforms",
  ...
  },
  {
    ...
    name: "Sidney Mores",
    role: "Frontend Developer",
    desc: "Specializing in modern frontend development with React & TypeScript",
    img: "/assets/profile-8.jpg",
  },
];
  ...
  return (
    <section className="w-full bg-white py-16 px-6 md:px-12 lg:px-24 font-gilroy">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-[#5C5C5C] mt-1 text-[14px] max-w-[480px] mx-auto">
      ...
      <div className="text-center flex flex-col justify-center items-center mt-14   ">
        ...
        <button className="px-6 py-3 bg-[#4359FF] hover:bg-indigo-700 text-white rounded-md font-medium">
          Join our Team
        </button>
      </div>
    </section>
