...
const IndustryCard = ({ icon, title }) => {
  return (
    <div className="bg-[#171717] border border-[#2B2B2B] rounded-xl py-6 sm:py-8 px-3 sm:px-4 flex flex-col items-center justify-center gap-3 sm:gap-4 shadow-md cursor-pointer">
